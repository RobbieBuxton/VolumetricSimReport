...
\begin{enumerate}
	\item Mention all positions are fixed and measured, maybe mention the distance between things?
\end{enumerate}

\textcolor{red}{Fix the issue with bad figure numbering for this below}
\begin{invisBox}  
	\pictureBox[label={fig:head-angle}]{Study Setup: Front View}{
	  \adjustbox{height=5cm, keepaspectratio}{
		\includegraphics{./implementation/figures/front-view.jpg}
	  }
	}
	\hfill
	\pictureBox[label={fig:incorrect-head-track}]{Study Setup: Side View}{
	\adjustbox{height=5cm, keepaspectratio}{
...
\textcolor{red}{Fix the issue with bad figure numbering for this below}
\begin{invisBox}  
	\pictureBox[label={fig:head-angle}]{Study Setup: Control View}{
	  \adjustbox{height=5cm, keepaspectratio}{
		\includegraphics{./implementation/figures/control-view.jpg}
	  }
	}
	\hfill
	\pictureBox[label={fig:incorrect-head-track}]{Study Setup: Calibration Device}{
	\adjustbox{height=5cm, keepaspectratio}{
