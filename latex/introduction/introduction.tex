...
\pictureBox{a) A volumetric display created at Columbia University using passive optical scattering \cite{10.1145/1179849.1179982}}{\includegraphics[width = \linewidth, keepaspectratio]{./introduction/figures/passive optical scatterers.png}}
\hfill
\pictureBox{b) A volumetric display created at Bristol University using acoustic trapping \cite{10.1063/1.5113467}}{\includegraphics[width = \linewidth, keepaspectratio]{./introduction/figures/acoustophoretic display.jpg}}
\end{tcbraster}
