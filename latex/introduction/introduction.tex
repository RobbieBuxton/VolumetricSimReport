...
\begin{invisBox}
\pictureBox[label={fig:passive-optical}]{a) A volumetric display created at Columbia University using passive optical scattering \cite{10.1145/1179849.1179982}}{
  \adjustbox{height=5cm, keepaspectratio}{
    \includegraphics{./introduction/figures/passive optical scatterers.png}
  }
}
\hfill
\pictureBox[label={fig:acoustic}]{b) A volumetric display created at Bristol University using acoustic trapping \cite{10.1063/1.5113467}}{
